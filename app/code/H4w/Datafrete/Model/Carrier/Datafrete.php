    ...
    public function collectRates(RateRequest $request)
    {
		...
		try {
			...
			foreach($wsResults['data'] as $shippingMethod) {
				...
				if ((int) $shippingMethod['cod_tabela'] == 0) {
					$shippingMethod['cod_tabela'] = 'Destino nao encontrado';
				}                
				...
				$method->setMethod($this->helperData->buildShippingMethodName($shippingMethod['cod_tabela']));
