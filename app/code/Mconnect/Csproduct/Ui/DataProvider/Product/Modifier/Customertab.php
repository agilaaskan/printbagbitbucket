            ...
            [
                static::GROUP_CUSTOMERTAB => [
                    ...
                    'arguments' => [
                        'data' => [
                            'config' => [
                                'label' => __('Product Specific Customer'),
                                'collapsible' => true,
                                'componentType' => Fieldset::NAME,
                                'dataScope' => static::DATA_SCOPE,
                              //  'sortOrder' =>  $this->getNextGroupSortOrder($meta, self::$previousGroup, self::$sortOrder),
                                'sortOrder' => 200,
                            ],
                        ],
    ...
    public function modifyData(array $data)
    {
        ...
        foreach ($this->getDataScopes() as $dataScope) {
            ...
            foreach ($collection as $linkItem) {
                if (in_array($linkItem->getId(), $availableCustomers)) {
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'label' => __('Products Specific Customer'),
                        'collapsible' => false,
                        'componentType' => Fieldset::NAME,
                        'dataScope' => '',
                        'sortOrder' => 10,
