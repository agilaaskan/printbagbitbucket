...
return [
    'modules' => [
        ...
        'H4w_Datafrete' => 1,
        'Hibrido_Bndes' => 1,
        'Hibrido_CustomerBR' => 1,
        'Hibrido_CustomerSintegra' => 1,
        'Hibrido_InstallmentPrice' => 1,
        'Klarna_Core' => 1,
        ...
        'MSP_TwoFactorAuth' => 1,
        'MageDad_LowStockNotification' => 1,
        'Magebees_Socialsharing' => 1,
        'Mageplaza_Core' => 1,
        'Mageplaza_Blog' => 1,
        ...
        'Mageplaza_Seo' => 1,
        'Mageplaza_Smtp' => 1,
        'Mconnect_Csproduct' => 0,
        'Mirasvit_Core' => 1,
        'Mirasvit_Feed' => 1,
        'Mirasvit_Report' => 1,
        'Prashant_Priceslider' => 0,
        'Temando_Shipping' => 1,
        'Vertex_Tax' => 1,
